...
const MSG_AUSENCIA = `🏍️ *Shineray Ipojuca*\n
...
A *Shineray Ipojuca* abriu e já estamos prontos pra te atender! 🚀`;
...
// === Descrições ===
const SOBRE_NOS = `🏍️ *Shineray Ipojuca*\n
...
client.on('message', async msg => {
  ...
  if (veioDoAnuncio) {
    ...
    await sendWithPause(msg.from, [
      `Olá ${nomeContato}! 👋 Sou o *Carlos*, atendente virtual da Shineray Ipojuca.`,
      `Seja bem-vindo(a)! 🚀`,
      MENU_TEXT
    ]);
